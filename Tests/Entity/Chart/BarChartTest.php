...
use Thuata\Bundle\ChartsBundle\Entity\Chart\TwoAxisChart\BarChart;

/**
 * Test for BarChart
 */
class BarChartTest extends ChartTest
{

    /**
     * Test for BarChart creation
     */
    public function testCreate()
    {
        $chart = BarChart::factory(self::CHART_NAME, self::CHART_SUMMARY);
